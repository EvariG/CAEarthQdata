...
Due to the nature of GitHub being unable to display the interactive maps, I uploaded photos of them to the "Photos_of_maps" folder. To view this interactive notebook and map without downloading this repo, view in google colab-->. <a target="_blank" href="https://colab.research.google.com/github/EvariG/CAEarthQdata/blob/main/CA%3ANV_seismicDBScan%26b-values_08%3A29%3A26.ipynb">
...
## b-values
- The lower the b-value the higher the proportion of large earthquakes to small earthquakes.
- A value of 1.0 indicates a proportion of 10 smaller earthquakes for 1 higher magnitude earthquake (ex. Ten 3M quakes for every One 4M quake).
- The lower the b-value the more crustal stress and proportionally more larger earthquakes.
